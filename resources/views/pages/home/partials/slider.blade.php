<div class="swiper hero-carousel relative w-full h-[calc(100vh-90px)]  md:h-[calc(100vh-134px)]">
    <div class="swiper-wrapper">
        ...
        {{-- RESERVATION PANEL --}}
        <div
            class="be-panel hidden md:block absolute bottom-40 lg:bottom-20 2xl:bottom-40 left-0 right-0 md:mx-6  lg:mx-32 2xl:mx-0 2xl:left-1/2 2xl:transform 2xl:-translate-x-1/2 bg-white">
        </div>
