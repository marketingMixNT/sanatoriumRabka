    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide relative w-full h-full ">
            <div class="max-w-screen-xl mx-auto flex justify-start items-center h-full pb-24">
                <div
                    class="h-full  max-w-[600px] flex flex-col justify-center items-start gap-8  z-10 text-fontLight px-6 lg:px-0">
        ...
        <x-link-button class="md:hidden absolute mt-12 bottom-32 left-1/2 transform -translate-x-1/2"
            href="https://booking.profitroom.com/pl/sanatoriumcegielskirabkazdroj/home?currency=PLN&codes=test"
            target="_blank" rel="noreferrer nofollow" aria-label="Rezerwuj">Zarezerwuj</x-link-button>
