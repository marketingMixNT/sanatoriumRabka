@props(['offer','href'])
    ...
    <a href="{{ $href }}" class="w-full sm:w-[550px] lg:w-[370px] border h-[370px] bg-center bg-cover bg-blend-multiply bg-gray-500 flex justify-center items-end rounded-sm shadow-md relative group text-center"
