@props(['offer','href'])
    ...
    <div class="absolute inset-0 bg-secondary-400 opacity-0 group-hover:opacity-90 duration-300 flex flex-col justify-center items-center p-6 text-fontLight">
        <h2 class="text-fontLight text-3xl font-medium mb-12">{{ $offer->title }}</h2>
